...
std::valarray<real> Distance::getDirectionArray(void) const {
...
std::valarray<real> Distance::getTangentArray(void) const {
...
real angleBetween(const real phi1, const real phi2) {
